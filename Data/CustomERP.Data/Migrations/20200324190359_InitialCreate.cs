        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetNumber = table.Column<string>(maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recipe = table.Column<string>(maxLength: 50, nullable: false),
                    Quantity = table.Column<int>(maxLength: 1000, nullable: false),
                    ContentWeight = table.Column<int>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sections_Sections_SectionParentId",
                        column: x => x.SectionParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedFrom = table.Column<string>(maxLength: 40, nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    ModifiedOn = table.Column<DateTime>(nullable: true),
                    ModifiedFrom = table.Column<string>(maxLength: 40, nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    DeletedFrom = table.Column<string>(maxLength: 40, nullable: true),
                    AddressId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_OrderId",
                table: "Sections",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Sections_SectionParentId",
                table: "Sections",
                column: "SectionParentId");
